...
double CalcDistanceP2P(POINT pt1, POINT pt2)
{
...
bool IsPointInSegmentRange(POINT pt, POINT startPoint, POINT endPoint)
{
	double minX = min(startPoint.x, endPoint.x);
	double maxX = max(startPoint.x, endPoint.x);
	double minY = min(startPoint.y, endPoint.y);
	double maxY = max(startPoint.y, endPoint.y);
