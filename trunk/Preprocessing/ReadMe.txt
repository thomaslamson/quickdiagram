========================================================================
    ACTIVE TEMPLATE LIBRARY : Preprocessing Project Overview
========================================================================

AppWizard has created this Preprocessing project for you to use as the starting point for
...
_Preprocessing.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (_Preprocessing.h)
        GUID definitions                                (_Preprocessing_i.c)
        A type library                                  (_Preprocessing.tlb)
        Marshaling code                                 (_Preprocessing_p.c and dlldata.c)
Preprocessing.cpp
...
StdAfx.h, StdAfx.cpp
    ...
    named Preprocessing.pch and a precompiled types file named StdAfx.obj.
...
Preprocessingps.vcproj
	...
	dlldata.c, Preprocessing_i.c and Preprocessing_p.c which are required
