========================================================================
    ACTIVE TEMPLATE LIBRARY : Recognition Project Overview
========================================================================

AppWizard has created this Recognition project for you to use as the starting point for
...
_Recognition.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (_Recognition.h)
        GUID definitions                                (_Recognition_i.c)
        A type library                                  (_Recognition.tlb)
        Marshaling code                                 (_Recognition_p.c and dlldata.c)
Recognition.cpp
...
StdAfx.h, StdAfx.cpp
    ...
    named Recognition.pch and a precompiled types file named StdAfx.obj.
...
Recognitionps.vcproj
	...
	dlldata.c, Recognition_i.c and Recognition_p.c which are required
